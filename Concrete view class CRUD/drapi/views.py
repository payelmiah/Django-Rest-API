...
from rest_framework.generics import ListCreateAPIView, RetrieveUpdateDestroyAPIView #class based view for CRUD operation 




#class based view for list and create
class AiquestList_List_Create(ListCreateAPIView):
